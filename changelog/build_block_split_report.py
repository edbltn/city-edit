...
<code>Dockerfile.blocks-overlay</code> pinned to the serving digest
(<code>a7e3a33c…</code>). Prod DB snapshotted to
<code>~/city-edit-prod-backups/20260729-203632/</code> before the deploy; staging-first, then
the same digest promoted to prod.</p>
"""
